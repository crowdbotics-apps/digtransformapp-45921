"""
Django settings for digtransformapp_45921 project.
...
ROOT_URLCONF = 'digtransformapp_45921.urls'
...
WSGI_APPLICATION = 'digtransformapp_45921.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "digtransformapp_45921 API",
    "DESCRIPTION": "API documentation for digtransformapp_45921 App",
    "VERSION": "v1",
}
